...
const Home = (props: HomeProps) => {
  ...
  const showWalletAddress = (walletAddress: string) => {
    let result = walletAddress.substring(0, 4) + '...' + walletAddress.substring(walletAddress.length - 4);
    return result;
  }
        ...
        >
          <Grid container justifyContent="space-between" direction="column">
            ...
            {wallet.connected && wallet.publicKey ? (
              <div className="user-wallet-block">
                <div className="address">
                  { showWalletAddress(wallet.publicKey.toString()) }
                </div>

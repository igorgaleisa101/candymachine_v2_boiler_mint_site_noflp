...
export const welcomeSettings: WelcomeSettings = {
  ...
  title: "Welcome Royal Knights NFT!",
  desc: "Connect your wallet and load in! Public mint starts soon!",

  // Countdown Timer
  countdownEnable: true,
  countdownTo: date("20 Jan 2022 24:00:00 GMT"),
  //Example date below
...
export const publicSaleSettings: PublicSaleSettings = {
  ...
  startDate: date("20 Jan 2022 24:00:00 GMT"),
  endDate: undefined,
  countdown: true,
  //Example date below
  // date('29 2021 00:00:00 GMT')
